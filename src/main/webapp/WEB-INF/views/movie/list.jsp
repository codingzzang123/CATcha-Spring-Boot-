...
<%--                            </label>--%>
                ...
                <li class="page-item"><a class="page-link" href="<c:url value='/search/movie?query=${query }&page=${now-1 }'/>">START</a></li> -->
                                ...
                                <c:if test="${paging.curPage ne 1 }">
                                    <li class="page-item"><a class="page-link" href="<c:url value='/movie/list?page=${paging.curPage-1 }&category=${category}&platform=${platform}'/>">&laquo;</a></li>
                                </c:if>
                                ...
                                <c:forEach begin="${paging.blockStartNum }" end="${paging.blockLastNum }" var="i">
                                    <c:choose>
                                        <c:when test="${i eq paging.curPage }">
                                            <li class="page-item active"><a class="page-link" href="<c:url value='/movie/list?page=${i }&category=${category}&platform=${platform}'/>">${i }</a></li>
                                        </c:when>
                                        <c:otherwise>
                                            <li class="page-item"><a class="page-link" href="<c:url value='/movie/list?page=${i }&category=${category}&platform=${platform}'/>">${i }</a></li>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                                ...
                                <c:if test="${paging.curPage ne paging.lastPageNum }">
                                    <li class="page-item"><a class="page-link" href="<c:url value='/movie/list?page=${paging.curPage+1 }&category=${category}&platform=${platform}'/>">&raquo;</a></li>
                                </c:if>
